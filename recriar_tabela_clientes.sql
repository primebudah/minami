-- Script completo para recriar a tabela clientes sem as colunas criado_em e atualizado_em
-- Execute no SQL Editor do Supabase

-- Passo 1: Dropar as funções RPC que dependem da tabela clientes
DROP FUNCTION IF EXISTS listar_clientes_rpc() CASCADE;
DROP FUNCTION IF EXISTS buscar_cliente_por_id_rpc(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS buscar_cliente_por_chassi_rpc(TEXT) CASCADE;
DROP FUNCTION IF EXISTS salvar_cliente_rpc(TEXT, TEXT, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, DATE, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS atualizar_cliente_rpc(INTEGER, TEXT, TEXT, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DATE, DATE, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS deletar_cliente_rpc(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS salvar_historico_rpc(INTEGER, TEXT, JSONB) CASCADE;
DROP FUNCTION IF EXISTS obter_ultima_acao_rpc() CASCADE;
DROP FUNCTION IF EXISTS deletar_historico_rpc(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS restaurar_cliente_excluido_rpc(INTEGER) CASCADE;
DROP FUNCTION IF EXISTS obter_ultima_exclusao_rpc() CASCADE;

-- Passo 2: Dropar a tabela original
DROP TABLE IF EXISTS clientes CASCADE;

-- Passo 3: Recriar a tabela clientes sem criado_em e atualizado_em
...
-- Passo 6: Dar permissões para as funções
...
-- Passo 7: Habilitar RLS e criar políticas
